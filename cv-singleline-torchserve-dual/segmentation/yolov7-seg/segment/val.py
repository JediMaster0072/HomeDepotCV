...
def parse_opt():
    ...
    # parser.add_argument('--weights', nargs='+', type=str, default='/home/saivijaay.vk/CV/yolov7-segmentation/segment/exp/weights/best.pt', help='model path(s)') #1st trainiing
    parser.add_argument('--weights', nargs='+', type=str, default='/home/saivijaay.vk/CV/Home-Depot-Labels-Data/Predictions/exp/weights/best.pt', help='model path(s)') #2nd trainiing
    ...
    parser.add_argument('--project', default=ROOT / 'runs/val-seg-label-data', help='save results to project/name')
