...
def build_masked_original_image(
    ...
    """Build a full-resolution OCR image where only likely SKU regions remain visible."""
    ...
    for item in all_items:
        ...
        if masked_clip is not None and masked_clip.size > 0:
            ...
            resized = cv2.resize(masked_clip, (crop_w, crop_h), interpolation=cv2.INTER_NEAREST)
