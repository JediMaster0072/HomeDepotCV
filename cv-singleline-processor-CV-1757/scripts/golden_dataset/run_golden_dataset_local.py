...
def expected_sku_fields(shape: dict, ocr_results: list[dict]) -> dict[str, str]:
    ...
    review_status = normalize_review_status(
        shape.get("expected_sku_review_status", ""),
        raw_expected,
        notes,
    )

    if review_status and review_status != SCORABLE_REVIEW_STATUS:
        return {
            "expected_sku": "N/A",
    ...
    return {
        ...
        "expected_sku_notes": notes,
        "review_status": review_status or SCORABLE_REVIEW_STATUS,
