...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='/home/saivijaay.vk/CV/yolov7-segmentation/weights/yolov7-seg.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/home/saivijaay.vk/CV/yolov7-segmentation/cfg/yolov7-seg.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/home/saivijaay.vk/CV/yolov7-segmentation/data/custom-seg.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='/home/saivijaay.vk/CV/yolov7-segmentation/data/hyps/hyp.scratch_label.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default='/home/saivijaay.vk/CV/Home-Depot-Labels-Data/Predictions', help='save to project/name')
    parser.add_argument('--name', default='exp_march_19_data', help='save to project/name')
    ...
    parser.add_argument('--freeze', nargs='+', type=int, default=[0,1,2,3], help='Freeze layers: backbone=10, first3=0 1 2')
